                ...
                <nav className="navbar navbar-expand-sm menu">
                    ...
                    <div className="navbar-collapse menuNavbar">
                        ...
                        <div className="navbar-nav">
                        {
                          ...
                          {
                            tokenredux === null ?<NavLink  className="nav-item nav-link navColor" to="/Login">Iniciar Sesión</NavLink>:<NavLink  className="nav-item nav-link navColor" to="/Logout">Cerrar Sesión</NavLink>
                           } 
                        </div>
                    </div>
                    </div>
